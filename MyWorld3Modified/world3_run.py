...
################################
# Comparaison Limits To Growth #
################################
#Scenario1
stand_aff(w3.t.hist,
            [w3.nrfr.hist, w3.io.hist, w3.f.hist, w3.pop.hist, w3.ppolx.hist],
            ["NRFR", "IO", "F", "POP", "PPOLX"],
            [[0, 2], [0, 4e12], [0, 6e12], [0, 10e9], [0, 37]],
            img_background="background/scenario1-1.png",
            grid=1,
            title="World3 Scenario 1 State of the World")

stand_aff(w3.t.hist,
          [w3.fpc.hist, w3.le.hist, w3.sopc.hist, w3.aiopc.hist],
          ["FPC", "LE", "SOPC", "AIOPC"],
          [[0, 1e3], [0, 90], [0, 1.1e3], [0, 600]],
            img_background="background/scenario1-2.png",
            grid=1,
            title="World3 Scenario 1 Material Standard of Living")

stand_aff(w3.t.hist,
          [w3.hwi.hist, w3.hef.hist],
          ["HWI", "HEF"],
          [[0, 0.9], [0, 4.5]],
            img_background="background/scenario1-3.png",
            grid=1,
            title="World3 Scenario 1 Human Welfare and Footprint")

#Scenario2
stand_aff(w3.t.hist,
            [w3.pop.hist, w3.iopc.hist, w3.nrfr.hist, w3.ppolx.hist, w3.fpc.hist],
            ["POP", "IOPC", "NRFR", "PPOLX", "FPC"],
            [[0, 16e9], [0, 1e3], [0, 1], [0, 32], [0, 1e3]],
            img_background=None,
            grid=1,
            title="World3 Scenario 2 State of the World")
stand_aff(w3.t.hist,
            [w3.fpc.hist, w3.le.hist, w3.sopc.hist],
            ["FPC", "LE", "SOPC"],
            [[0, 1e3], [0, 100], [0, 1e3]],
            img_background=None,
            grid=1,
            title="World3 Scenario 2 Material Standard of Living")
stand_aff(w3.t.hist,
            [w3.hwi.hist, w3.hef.hist],
            ["HWI", "HEF"],
            [[0, 1], [0, 5]],
            img_background=None,
            grid=1,
            title="World3 Scenario 2 Human Welfare and Footprint")